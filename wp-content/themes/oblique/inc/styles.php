...
function oblique_custom_styles($custom) {
	...
	if ( $body_fonts !='' ) {
		$custom .= "body { font-family:" . esc_attr($body_fonts) . ";}"."\n";
	}
	if ( $headings_fonts !='' ) {
		$custom .= "h1, h2, h3, h4, h5, h6 { font-family:" . esc_attr($headings_fonts) . ";}"."\n";
	}
    //Site title
	...
	//Header padding 1024
	$branding_padding_1024 = get_theme_mod( 'branding_padding_1024', '150' );
